...
const AddRecipe = () => {
    ...
    const createRecipe = async(e) => {
        e.preventDefault();
        setBtnLoading(true); // Set loading to true when form is being submitted
        ...
        try{
            ...
            axios.post(`${BASEURL}/api/storerecipes`, formData).then(res => {
                        ...
                        <div className="other-body">
                            <form onSubmit={createRecipe} encType="multipart/form-data">
                                ...
                                <div className="group-6">
                                    <button type="submit" disabled={btnLoading}>{btnLoading ? 'Loading...': 'Create Recipe'}</button>
                                </div>
                            </form>

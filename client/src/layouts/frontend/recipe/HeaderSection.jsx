...
const HeaderSection = () => {
    ...
    const getRecipe = async() => {
        try{
            const response = await axios.get(`${BASEURL}/api/get-recipe/${slug}`);
    ...
    const submitComment = async(e) => {
        ...
        try{
            ...
            const response = await axios.post(`${BASEURL}/api/store-comment`, data);
    ...
    const getComments = async() => {
        try{
            const response = await axios.get(`${BASEURL}/api/show-comments/${slug}`);
        ...
        <>
            <div className="recipe-head-section">
                ...
                <div className="recipe-image">
                    ...
                    <img src={`${BASEURL}/uploads/${recipe.file}`} alt={recipe.name} loading='lazy' width={50}  height={190}/>
